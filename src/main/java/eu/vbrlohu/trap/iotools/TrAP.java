...
public class TrAP {
	...
	public static void main(String[] args) {
		...
		case 'd': 
				double distance=0;
				distance=Tree.totalDist(mytrees.get(0),mytrees.get(1));
	...
	// finds the smallest index in a string 'string' after i, which contains a character from a string 'characters', if does not contains any, returns string.length
